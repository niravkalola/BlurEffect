package com.nkdroid.blur.effect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(1000, 1000) {
            ...
            public void onFinish() {
                ...
                Bitmap blurred = fastblur(bitmap, 1, 10);//second parametre is radius
        ...
        seekBarBlur.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                if (i == 0) {
                    ...
                    Bitmap blurred = fastblur(bitmap, 1, i);//second parametre is radius
                    bgImage.setImageBitmap(blurred);
                    bgImage.invalidate();
